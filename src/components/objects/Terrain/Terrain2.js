...
class Terrain2 extends Group {
    constructor(parent) {
        ...
        this.xLength = 10; // number of chunks long in x direction
        this.yLength = 6; // number of chunks tall in y direction
        this.zLength = 10; // number of chunks long in z direction
        this.chunks = [];
    ...
    addTerrain(location, scene) {
        const width = Math.round(0.35 * this.resolution);
    ...
    deleteTerrain(location, scene) {
        const width = Math.round(0.45 * this.resolution);
